try:
    ...
    import tensorflow as tf  # Retry import after installation
...
if selected =='About US':
    def app():
        st.title('Welcome!')
        st.write('This web app uses a CNN model to detect the presence of Alzheimers disease in individuals of any age group. Instead of relying on traditional MRI scans, our portable web app provides a quick and efficient way to analyze medical images and generate reports instantly.')
